...
export const ui = {
  bg: {
    ...
    'site.description':
      'Момчил Степанов — voice talent, наратор и продуцент на аудиокниги. Над 200 аудиокниги, 5000+ документални продукции, стотици филми и сериали.',

    'nav.home': 'Начало',
    'nav.services': 'Услуги',
    'nav.services.advertising': 'Реклами',
    'nav.services.voiceOver': 'Глас зад кадър',
    ...
    'form.projectType.options': 'Реклама | Voice Over | Аудиокнига | Друго',
  ...
  en: {
    ...
    'site.description':
      'Momchil Stepanov — voice talent, narrator and audiobook producer. Over 200 audiobooks, 5000+ documentary productions, hundreds of films and series.',
    ...
    'form.projectType.options': 'Advertising | Voice Over | Audiobook | Other',
